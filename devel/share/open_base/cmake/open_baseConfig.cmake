...
if("TRUE" STREQUAL "TRUE")
  set(open_base_SOURCE_PREFIX /home/rizky/polbot_ws/src/open_base)
  set(open_base_DEVEL_PREFIX /home/rizky/polbot_ws/devel)
  ...
  set(open_base_INSTALL_PREFIX /home/rizky/polbot_ws/install)
...
if(NOT "/home/rizky/polbot_ws/devel/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(open_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/rizky/polbot_ws/devel/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rizky/polbot_ws/src/open_base/${idir}'.  ${_report}")
    endif()
    _list_append_unique(open_base_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "open_base;orocos-kdl")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rizky/polbot_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(open_base_EXPORTED_TARGETS ${${open_base_dep}_EXPORTED_TARGETS})
endforeach()
