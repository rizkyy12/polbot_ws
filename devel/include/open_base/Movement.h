...
// reducing the odds to have name collisions with Windows.h 
#if defined(_WIN32) && defined(BEZIER)
  #undef BEZIER
#endif
  ...
  #undef NONE
#endif
#if defined(_WIN32) && defined(WHEEL)
  #undef WHEEL
#endif
#if defined(_WIN32) && defined(POSITION_ABSOLUTE)
  #undef POSITION_ABSOLUTE
#endif
#if defined(_WIN32) && defined(POSITION_RELATIVE)
  #undef POSITION_RELATIVE
#endif
  ...
  #undef MOBILE
#endif
#if defined(_WIN32) && defined(MOBILE_RAW)
  #undef MOBILE_RAW
#endif
...
bool operator==(const ::open_base::Movement_<ContainerAllocator1> & lhs, const ::open_base::Movement_<ContainerAllocator2> & rhs)
{
