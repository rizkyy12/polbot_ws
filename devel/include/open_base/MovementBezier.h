...
bool operator==(const ::open_base::MovementBezier_<ContainerAllocator1> & lhs, const ::open_base::MovementBezier_<ContainerAllocator2> & rhs)
{
  return lhs.frame == rhs.frame &&
    lhs.targetTranslation == rhs.targetTranslation &&
    lhs.targetRotation == rhs.targetRotation &&
    lhs.step == rhs.step &&
    lhs.offsetTraslation == rhs.offsetTraslation &&
    lhs.offsetRotation == rhs.offsetRotation;
}
