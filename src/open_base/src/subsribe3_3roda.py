...
def motor():
    ...
    rospy.Subscriber("/vel_roda1", Float64, motor1pub_callback)
    rospy.Subscriber("/vel_roda2", Float64, motor2pub_callback)
    rospy.Subscriber("/vel_roda3", Float64, motor3pub_callback)
    rospy.spin()         
