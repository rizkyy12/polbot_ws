...
x_distance = input('masukkan nilai distance X = ')
distance12x = float(x_distance)
y_distance = input('masukkan nilai distance Y = ')
distance12y = float(y_distance)
...
if __name__ == '__main__':
    ...
    # fuzzy12()
    print('Speed Vx=', speed_vx, 'Speed Vy=', speed_vy)
