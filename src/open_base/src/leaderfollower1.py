...
# ____ Tambah Coba Konsensus  BERES
...
def caseFormation():
    ...
    selisihX = consenX - beginX1 
    selisihY = consenY - beginY1

    if (selisihY) <= (selisihX) :
        # targetX1 = consenX
        # targetY1 = consenY + 0.5

        # targetX2 = consenX - 0.5
        # targetY2 = consenY

        # targetX3 = consenX + 0.5
        # targetY3 = consenY

        targetX1 = consenX + 0.5
        targetY1 = consenY 

        targetX2 = consenX 
        targetY2 = consenY - 0.5

        targetX3 = consenX 
        targetY3 = consenY + 0.5
        print ("0.5 dari y")
        print('tx1=', targetX1, 'ty1=', targetY1)
        print('x1=', beginX1, 'y1=', beginY1)
        print('sX=', selisihX, 'sY=', selisihY)
    else :
        # targetX1 = consenX + 0.5
        # targetY1 = consenY 
...
def consensus():
    ...
    print('x=', consenX, 'y=', consenY)
    print('x1=', x1, 'y1=', y1, 'x2=', x2, 'y2=', y2,'x3=', x3, 'y3=', y3)
    # print('x1=', beginX1, 'y1=', beginY1)
    # print('x2=', beginX2, 'y2=', beginY2)
    # print('x3=', beginX3, 'y3=', beginY3)
    print('')
